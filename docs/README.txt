...
// Purpose of file: README (pour le français, voir LISEZMOI)
// ----------------------------------------------------------------------

Authors : Dévi BALPE & Walid NOUH & Remi COLLET 

This plugin enables additional reports

- This plugin allow you to add new reports in a simply way
...
- New report can be easily created using the SimpleReport function
